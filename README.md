...
| **Inspection & Reports**   | Milestone schedule, engineer-signed inspections with geotagged photo proof, escrow tranche release, and a structural engineer's console (`/engineer`) that gathers every stage awaiting their signature and every drawing set they owe across all projects into one queue                                                                                                                     |
| **Site Diary**             | Daily log with labour, materials and equipment, stamped with the weather over the plot                                                                                                                                                                                                                                                                                                        |
| **Marketplace**            | Supplier product listings, a DB-backed cart (one order per line at checkout), gateway checkout, road-distance delivery ETA to the build site                                                                                                                                                                                                                                                  |
...
| **Dashboard**              | Role-aware landing page — stats, attention items and upcoming events aggregated live from each actor's own projects, bids, proposals, meetings and disputes, not cached or mocked                                                                                                                                                                                                            |
