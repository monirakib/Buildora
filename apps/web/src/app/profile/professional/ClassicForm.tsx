...
/**
 * The original single-page profile editor, kept for engineers, contractors,
 * and suppliers. Architects use the verification wizard instead.
 */
export function ClassicProfessionalForm() {
